		...
		<view class="header" v-bind:class="{'status':isH5Plus}">
			<view class="userinfo">
				...
				<view class="info">
					...
					<view class="integral reputation">信誉:{{userinfo.reputation}}</view>
				</view>
			</view>
...
.header{
	...
	background-color:#4080ff;width:92%;height:30vw;padding:0 4%;display:flex;align-items:center;
	.userinfo{
...
.orders{
	background-color:#4080ff;width:92%;height:11vw;padding:0 4%;margin-bottom:calc(11vw + 40upx);display:flex;align-items:flex-start;border-radius:0 0 100% 100%;margin-top: -1upx;
	.box{
...
.list{
	...
	.li{
		background-color:#fff;width:92%;height:100upx;padding:0 4%;border-bottom:solid 1upx #e7e7e7;display:flex;align-items:center;
